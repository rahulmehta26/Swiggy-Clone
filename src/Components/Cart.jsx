...
function Cart() {
  ...
  const handleSubmitAddres = () => {
    ...
    const addressInfo = { area, landmark, zipCode, id:uniqueId };
      ...
      {cartData.length === 0 ? (
        ...
        <div className="w-full ">
          <div className="w-[75%] flex gap-10 justify-between mx-auto p-2 ">
            ...
            <div className="overflow-y-scroll overflow-x-hidden py-4 h-[24rem]">
              
              <div className="w-[35%]  bg-white p-4">
                <div
                  className="w-[22rem] space-y-8 flex flex-col justify-between border border-dashed border-[#E9E9EB] hover:shadow-lg p-4"
                ...
                >
                  ...
                  <button className="w-[8rem] text-[#66B246] mb-2 ml-12 font-medium border border-[#66B246] p-2">
                    ADD NEW
                  </button>
                </div>
              </div>
              ...
              {dataAddress &&
                dataAddress?.map((data, index) => {
                  return (
                    <div key={index} className="w-[35%]  bg-white pt-4 px-4">
