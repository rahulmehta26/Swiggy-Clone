...
const Offers = () => {
  ...
  const filteredData = data.filter((item) => item?.info?.aggregatedDiscountInfoV3?.header || item?.info?.aggregatedDiscountInfoV3?.subHeader );
        ...
        <div className="w-full pt-8 p-4 border border-[#E5E6E6] rounded-xl mt-16">
          ...
          <p>
           ...
           <p>
            ...
            out enticing deals and discounts that are too good to resist. From
...
<p>
            ...
            Imagine biting onto a juicy burger paired with a
            side of crispy fries, all at a fraction of the regular price. Or how
            about treating yourself to a cheesy, oven-fresh pizza with your
            favourite toppings without worrying about the bill? With these
            incredible offers, indulging in your beloved dishes has never been
            more budget-friendly. 
            </p>

            <p>
            
            So, whether you're planning a cosy night in, a
            family feast, or a fun dinner with friends, take advantage of these
            fantastic deals. It's time to savour the flavours you adore without
            emptying your wallet. Order now, support your local restaurants, and
            make every meal a delightful and cost-effective experience. Don't
            miss out – let your taste buds rejoice, and your savings grow with
            these irresistible food offers on Swiggy!
          </p>
                </>
              ) : (
              <h1 
              className="text-[.9rem] cursor-pointer flex items-center font-bold text-[#FF5200] "
              onClick={() => setShowInfo(true)} >See more <span><IoIosArrowDown className="w-4 h-4" /></span> </h1>
            )
            }
